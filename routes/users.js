...
let { UserCreateValidator, UserUpdateValidator, validate } = require('../utils/validator');
/* GET users listing. */
...
router.post('/', UserCreateValidator, validate, async function (req, res, next) {
  try {
    let body = req.body;
...
router.put('/:id', UserUpdateValidator, validate, async function (req, res, next) {
  try {
    let body = req.body;
